window.addEventListener("load", () => {
  ...
  class Player {
    ...
    draw(context) {
      ...
      if (this.game.debug) {
        context.beginPath(); // draw circle to represent player & close previous shape
        context.arc(
          this.collisionX,
          this.collisionY,
        ...
        context.restore();
        context.stroke();
        context.beginPath(); // new shape
        context.moveTo(this.collisionX, this.collisionY); //starting coordinates
        context.lineTo(this.game.mouse.x, this.game.mouse.y); //ending coordinates
  ...
  class Game {
    ...
    removeGameObjects() {
      this.eggs = this.eggs.filter((object) => {
